...
public class TestController {
	...
	public Set<TestDescription> getTestDescriptionsForCategory(@NotBlank @PathVariable(CATEGORY_ID_PARAM) String categoryID) {
	...
	public TestScore submitTest(@NotBlank @PathVariable(TEST_ID_PARAM) String testID,
		...
		result.setUserEmail("test@google.com");
