...
public class TestControllerTest {
	...
	public void setup() {
		...
		controller = new TestController(repository, testProvider, new TestScorerImpl(), mockUserFactory());
	}
	...
	public void testSubmitAnswer() throws IOException {
		...
		assertEquals("Unexpected user", USER_ID, persisted.getUserId());
	}
	...
	private UserServiceFactory mockUserFactory() {
		UserServiceFactory userServiceFactory = Mockito.mock(UserServiceFactory.class);
		UserService userService = Mockito.mock(UserService.class);
		Mockito.when(userServiceFactory.create()).thenReturn(userService);
